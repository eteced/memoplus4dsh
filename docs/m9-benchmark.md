...
- **FC-SH 三个长度完成：6k 83.0 / 32k 81.0 / 64k 78.0（各 100 题）**——均远超 Table 2 全体（最高 GPT-4o 60.0；RAG/记忆类最高 HippoRAG-v2 54.0、Mem0 18.0）。衰减极缓（83→81→78），相比论文中"长度增加性能骤降"的普遍现象（o4-mini 80.0→14.0），本组合的实体-时间图 + 状态去重架构在 Selective Forgetting 轴上表现突出。注意 o4-mini 的 6k FC-SH/MH 也是高分——推理骨架有贡献，最终结论需看 262k 与 MH。
