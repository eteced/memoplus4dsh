...
- **FC-SH 6k 完成：EM 83.0（100 题）**——远超 Table 2 全体（最高 GPT-4o 60.0；RAG/记忆类最高 HippoRAG-v2 54.0、Mem0 18.0）。注意 6k 是最短长度（论文 Table 4 也显示短上下文可解），关键看 32k/64k/262k 的衰减。
